...
router.get("/products/import/template")(controller.get_import_template)
router.get("/products/export")(controller.export_products)
router.post("/products/import")(controller.import_products)
router.get("/products", response_model=PaginatedResponse[ProductResponse])(controller.list_products)
...
router.get("/platform-orders", response_model=PaginatedResponse[PlatformOrderResponse])(controller.list_platform_orders)
router.post("/platform-orders", response_model=PlatformOrderResponse)(controller.create_platform_order)
router.patch("/platform-orders/{order_id}/status", response_model=PlatformOrderResponse)(controller.update_order_status)
router.get("/returns-analysis")(controller.returns_analysis)
